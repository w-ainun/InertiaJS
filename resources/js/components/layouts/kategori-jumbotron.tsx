...
export default function KategoriJumbotron({ judul, keterangan, gambar }: JumbotronProps) {
  return (
    <section className="relative mx-16 mt-6 rounded-2xl overflow-hidden shadow-lg bg-cover bg-center" style={{ backgroundImage: `url(${gambar})`, }} >
  {/* Overlay */}
  <div className="absolute inset-0 h-[477px] bg-[#f4f4f4e6] rounded-xl" />

  {/* main content */}
  <div className="relative z-[2] flex justify-between items-center p-10">
    {/* Konten kiri */}
    <div className="flex-1">
      <p className="text-lg text-gray-600 mb-2">{keterangan}</p>
      <h1 className="text-4xl font-bold text-[#1C1C1E] mb-6">Aneka {judul}</h1>
